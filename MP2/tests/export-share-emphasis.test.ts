...
describe("export scaffolds", () => {
  ...
  it("generates downloadable PDF and FigJam artifacts", async () => {
    ...
    expect(pdf.artifactFilename).toBe("affinity-board-printable.html");
    expect(pdf.artifactMimeType).toContain("text/html");
    expect(pdf.artifactPreview).toContain("<!doctype html>");
    expect(pdf.artifactPreview).toContain("generated by AffinityFlow");
